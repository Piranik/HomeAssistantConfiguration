...
from homeassistant.components.weather import (
    ...
    ATTR_FORECAST_WIND_SPEED, ATTR_WEATHER_TEMPERATURE, ATTR_WEATHER_PRESSURE, ATTR_WEATHER_HUMIDITY,
...
from .const import (
    ...
    CONDITION_FOG_CLASSES, ATTR_SUNRISE, ATTR_WEATHER_CLOUDINESS, ATTR_SUNSET, ATTR_WEATHER_PRECIPITATION_INTENSITY,
    ATTR_WEATHER_PRECIPITATION_TYPE, ATTR_WEATHER_STORM, ATTR_WEATHER_PHENOMENON, ATTR_FORECAST_PRECIPITATION_TYPE,
    ATTR_WEATHER_CONDITION, ATTR_WEATHER_PRECIPITATION_AMOUNT, ATTR_WEATHER_GEOMAGNETIC_FIELD, ATTR_FORECAST_CLOUDINESS,
    ATTR_FORECAST_PRECIPITATION_AMOUNT, ATTR_FORECAST_PRECIPITATION_INTENSITY, ATTR_FORECAST_STORM,
...
class Gismeteo:
    ...
    def __init__(self, latitude=None, longitude=None, mode='hourly', params=None):
...
if __name__ == '__main__':
    ...
    print(gm.pressure_hpa())
    print(gm.humidity())
    print(gm.wind_bearing())
    print(gm.wind_speed_kmh())
